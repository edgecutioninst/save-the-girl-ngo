      ...
      <form className="bg-white p-8 rounded-lg border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <input type="text" className="w-full p-2.5 border border-slate-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none" placeholder="Enter full name" />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700">Gender</label>
            <select className="w-full p-2.5 border border-slate-300 rounded-md bg-white focus:ring-2 focus:ring-blue-500 outline-none">
              <option>Male</option>
          ...
          <div className="space-y-2">
            ...
            <input type="date" className="w-full p-2.5 border border-slate-300 rounded-md outline-none" />
          </div>
          <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <select className="w-full p-2.5 border border-slate-300 rounded-md bg-white outline-none">
          ...
          <div className="space-y-2">
            ...
            <input type="text" className="w-full p-2.5 border border-slate-300 rounded-md outline-none" placeholder="e.g. Web Developer" />
          </div>
          <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 gap-6">
          <div className="space-y-2">
            ...
            <input type="text" className="w-full p-2.5 border border-slate-300 rounded-md outline-none" placeholder="Enter university name" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input type="number" min="1" max="5" className="w-full p-2.5 border border-slate-300 rounded-md outline-none" placeholder="5" />
            </div>
          </div>

          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700">Photos / Google Drive Link</label>
            <input type="url" className="w-full p-2.5 border border-slate-300 rounded-md outline-none text-blue-600" placeholder="https://drive.google.com/..." />
          </div>

          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700">Remarks</label>
            <textarea className="w-full p-2.5 border border-slate-300 rounded-md h-24 outline-none" placeholder="Add any additional notes here..."></textarea>
          </div>
        </div>
